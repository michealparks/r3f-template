...
var EffectComposer2 = import_react.default.memo((0, import_react.forwardRef)((_ref, ref) => {
  ...
  const [composer, normalPass] = (0, import_react.useMemo)(() => {
  ...
  (0, import_react.useLayoutEffect)(() => composer == null ? void 0 : composer.setSize(size.width, size.height), [composer, size]);
...
var EffectComposer$1 = EffectComposer2;
...
var Outline = (0, import_react.forwardRef)(function Outline2(_ref, ref) {
  let _a = _ref, {
    selection = [],
    selectionLayer = 10,
    blendFunction,
  ...
  (0, import_react.useEffect)(() => {
    ...
    effect.setSelection(Array.isArray(selection) ? selection.map((ref2) => ref2.current) : [selection.current]);
  }, [effect, selection]);
  (0, import_react.useEffect)(() => {
...
var addLight = (light, effect) => {
  if (light.current) {
    light.current.layers.enable(effect.selection.layer);
  }
};
var removeLight = (light, effect) => {
  if (light.current) {
    light.current.layers.disable(effect.selection.layer);
  }
};
var SelectiveBloom = (0, import_react.forwardRef)(function SelectiveBloom2(_ref, ref) {
  let {
    selection = [],
    selectionLayer = 10,
    lights = [],
  ...
  (0, import_react.useEffect)(() => {
    effect.selection.set(Array.isArray(selection) ? selection.map((ref2) => ref2.current) : [selection.current]);
  }, [effect, selection]);
  (0, import_react.useEffect)(() => {
...
var SSAO = (0, import_react.forwardRef)(function SSAO2(props, ref) {
  ...
  const effect = (0, import_react.useMemo)(() => {
    ...
    return new SSAOEffect(camera, normalPass.renderTarget.texture, __spreadValues({
      blendFunction: BlendFunction.MULTIPLY,
      samples: 30,
      rings: 4,
      distanceThreshold: 1,
...
var LUT = (0, import_react.forwardRef)(function LUT2(_ref, ref) {
  ...
  const effect = (0, import_react.useMemo)(() => new LUTEffect(lut, props), [lut, props]);
  (0, import_react.useLayoutEffect)(() => {
    if (lut)
      effect.setLUT(lut);
...
export {
  ...
  DepthOfField,
  DotScreen,
  EffectComposer$1 as EffectComposer,
